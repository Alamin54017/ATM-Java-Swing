 ...
 * @author acer-pc
 */
public class addac extends javax.swing.JFrame {
...
public void card(){
    try{
           ...
           String sql="select *from accounts ORDER BY CardNo DESC LIMIT 1 ";
           stt=conn.prepareStatement(sql);
           rs=stt.executeQuery();
           rs.next();
           int a=rs.getInt("CardNo");
           a++;
           ID.setText(Integer.toString(a));
       }
    ...
    private void initComponents() {
        ...
        jLabel15.setText("XXXX-XXXX-XXXX-");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                ...
                PreparedStatement updateemp = conn.prepareStatement("INSERT INTO accounts (CardNo,Name,FName,MName,Gender,Dob,Nationality,Religion,Marital,Address,Paddress,Bgroup,Pin,Balance) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                updateemp.setInt(1,Integer.parseInt(ID.getText())); 
                ...
                updateemp.setInt(13,Integer.parseInt(PASSWORD.getText()));
                updateemp.setDouble(14,0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
